...
public class MainActivity extends AppCompatActivity {
    ...
    private DateTimeFormatter dr = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSS");
    private DateTimeFormatter dz = DateTimeFormatter.ofPattern("HH");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NotificationChannel channel = new NotificationChannel("35", "channel", NotificationManager.IMPORTANCE_HIGH);
        ...
        TmTk1 = new TimerTask() {
            ...
            public void run() {
                ...
                builder.setProgress(PROGRESS_MAX, PROGRESS_CURRENT, false);
                builder.setContentText(yString);
                notificationManager.notify(1, builder.build());
            }
        };
